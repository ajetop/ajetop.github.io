...
const Layout={
  ...
  tentang(p){
    return `<section class="section"><div class="section-head"><h2>Tentang</h2></div><div class="card"><p class="lead">Saya bantu brand & startup ubah ide jadi produk yang dipakai orang \u2014 bukan cuma dilihat.</p><div class="info-grid"><div class="info"><span class="k">Lokasi</span><span class="v">${p.location} \u2022 Remote</span></div><div class="info"><span class="k">Role</span><span class="v">${p.role}</span></div><div class="info"><span class="k">Fokus</span><span class="v">Mobile UI \u2022 Design System</span></div></div><div class="values"><div class="value"><b>01</b><h4>Cepat & Ringan</h4><p>Optimasi performa, 60fps</p></div><div class="value"><b>02</b><h4>Intuitif</h4><p>Navigasi jelas</p></div><div class="value"><b>03</b><h4>Clean</h4><p>Whitespace rapi</p></div></div></div></section>`;
  },
  skills(sk){
